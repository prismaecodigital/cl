...
<head>
    ...
    <style>
        @page {margin-bottom: 20mm;}.header-logo,.text--center{text-align:center}.footnote-table,.info-table,.note-table,.schedule-table,.sign-table{width:100%;border-collapse:collapse}*,::after,::before{box-sizing:inherit;-moz-box-sizing:inherit;-webkit-box-sizing:inherit}html{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box}body{padding:0;margin:0;font-size:15px;font-family:Figtree,sans-serif}.content{width:100%;height:100%;position:relative;display:block;}.page-break{page-break-after:always}.header-logo{display:block;width:100%;height:auto;margin-bottom:.5em}.header-logo>img{width:auto;height:80px}.text--heading,.text--title{font-family:Figtree,sans-serif;font-weight:700}.space{padding:0 1em}.text--heading{font-size:1.2em!important;margin-top:.5em!important;margin-bottom:0!important}.text--heading~p{margin-top:0!important;margin-bottom:1.5em!important}.text--title{font-size:1.15em!important}.text--sub-title{font-size:1.15em!important;margin-bottom:.5em!important}.sign-table td:first-child,.text--left{text-align:left}.sign-table td:nth-child(2),.text--right{text-align:right}.info-table{margin:10px 0}.info-table td,.info-table th{border:1px solid #000;padding:2px 4px;text-align:left}.info-table th,.info-table tr:first-child{font-weight:700!important}.info-table td:first-child{font-weight:700;width:200px!important}.note-table thead th{padding:1em .5em;border:1px solid #000}.note-table tbody td{padding:.5em;border:1px solid #000}.schedule-table{text-align:center}.schedule-table td,.schedule-table th{padding:2px;border:1px solid #000;width:100%!important;max-width:calc(100% / 6)!important}.term-list li{margin-bottom:.35em}.sign-table{margin-top:1em}.sign-table td{vertical-align:top;width:calc(100% / 2)}.sign-image{height:80px!important}.footnote{position:fixed;bottom:0;left:0;right:0;height:50px;text-align:center;font-size:.8em;color:#666!important}.footnote a{color:inherit!important}.footnote>p{margin-top:0!important;margin-bottom:2px!important}.footnote-table td{vertical-align:top;text-align:center;width:calc(100% / 3)}
    </style>
</head>
<body>
    ...
    <script type="text/php">
        if (isset($pdf)) {
            $pdf->page_script('
                ...
                $size = 9;
                $yTop = $pdf->get_height() - 50; // Vertical position from the bottom
                $yBottom = $pdf->get_height() - 30; // Vertical position from the bottom
